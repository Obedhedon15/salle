...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container">
            <a class="navbar-brand" href="#">SNEL - Login agent</a>
        </div>
    </nav>
    ...
    <div class="container d-flex justify-content-center align-items-center flex-grow-1">
        <div class="form-container">
            ...
            @endif
            {{-- Message d’erreur provenant de la session --}}
@if (session('error'))
    <div class="alert alert-danger mb-4">
        {{ session('error') }}
    </div>
...
@endif
            ...
            <form action="{{ route('handleAgentLogin') }}" method="POST">
                @csrf
