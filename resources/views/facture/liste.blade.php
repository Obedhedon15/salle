...
<head>
    ...
    <title>SNEL - Gestion des Factures</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container">
            <a class="navbar-brand" href="#">SNEL - Gestion des Factures</a>
        </div>
    </nav>

    <!-- Main Content - Facture List -->
    <div class="container d-flex justify-content-center align-items-start flex-grow-1">
        <div class="container-main">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                {{-- Barre de recherche --}}
                <form action="{{ route('facture.liste') }}" method="GET" class="search-bar d-flex flex-grow-1 ms-3">
                        ...
                        @forelse ($factures as $facture)
                            <tr>
                                ...
                                <td>
                                    ...
                                    {{-- Payer la facture si elle n’est pas déjà payée --}}

    
<a href="{{ route('paiements.ajouter', ['facture_id' => $facture->id]) }}" class="btn btn-primary">
    Payer
</a>
                                </td>
                            </tr>
