    ...
    <header class="hero-section">
        <div class="container">
            ...
            <div class="d-flex justify-content-center">
                <a href="/loginClient" class="btn btn-custom btn-client">Connexion Client</a>
                <a href="/loginAgent" class="btn btn-custom btn-agent">Connexion Agent</a>
                <a href="/loginAdmin" class="btn btn-custom btn-admin">Connexion Administrateur</a>
            </div>
        </div>
    </header>
